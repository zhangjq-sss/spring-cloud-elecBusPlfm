		...
		try {
			...
			for (Field field : fields) {
				...
				if (!o1.toString().equals(o2.toString())) {
					if(field.getName().equals("updTime")||field.getName().equals("updHost")||field.getName().equals("updUser")||field.getName().equals("updName")){
						continue;
					}
					if(i!=1){
						str1+=" ";
					...
					str1+=i+"."+field.getName()+"-旧值:"+o1;
					str2+=i+"."+field.getName()+"-新值:"+o2;
					i++;
				}
			}
		} catch (Exception e) {
