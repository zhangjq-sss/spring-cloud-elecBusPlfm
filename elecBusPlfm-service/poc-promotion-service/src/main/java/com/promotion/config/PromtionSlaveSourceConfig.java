...
@Configuration
@MapperScan(basePackages = "com.promotion.internal.slave",sqlSessionFactoryRef = "promotionSlaveSqlSessionFactory")
public class PromtionSlaveSourceConfig {
    ...
    @Bean(name = "promotionSlaveSqlSessionFactory")
